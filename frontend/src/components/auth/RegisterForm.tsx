                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormMessage>
                                {list2Ul(backendErrors?.username)}
                            </FormMessage>
                        </FormItem>
                    )}
                />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormMessage>
                                {list2Ul(backendErrors?.password1)}
                            </FormMessage>
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormMessage>
                                {list2Ul(backendErrors?.password2)}
                            </FormMessage>
                        </FormItem>
                    )}
                />
                <FormMessage>
                    {list2Ul(backendErrors?.non_field_errors)}
                </FormMessage>
